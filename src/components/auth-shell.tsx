    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-muted/30 p-4">
      ...
      <div className="flex w-full max-w-sm flex-col gap-6">
        <Link href="/" className="flex items-center justify-center gap-2 text-lg font-semibold tracking-tight">
          <span className="brand-gradient-live shadow-glow flex size-8 items-center justify-center rounded-lg text-sm font-bold text-white">
            CT
          </span>
          {APP_NAME}
        </Link>
        <div className="animate-fade-in-up rounded-xl border bg-card p-6 shadow-md sm:p-7">
